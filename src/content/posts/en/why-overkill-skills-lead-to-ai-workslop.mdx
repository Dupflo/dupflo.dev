...
description: I ran RPI and its twenty-three agent skills on a six-file change. It produced 3,418 lines of planning and estimated seven to ten person-days. I shipped it in thirty minutes.
date: 2026-08-11
lang: en
...
Developing by firing off a pile of prompts without ever verifying anything, with “it works fine” as the only argument I had — until the first wave of bugs made me understand that the product was a mess, and that it needed refactoring from the very first line of code.
...
With Applyzi, it took three to four weeks of planning and controlling every feature, spending more credits to make React components reusable. Exactly like I used to do before. It cost me more time up front, but three months on the project is maintainable and scalable, and I am not scared of recoding parts of it myself.
